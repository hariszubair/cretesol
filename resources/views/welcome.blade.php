...
<head>
  ...
  <link href="{{asset('css/bootstrap.min.css')}}" rel="stylesheet">
	...
	html{
		height:100%;
		background: #ffffff url('images/slider1.jpg'); no-repeat center bottom fixed;
...
<body>
	<div id="cspio-page" style=" margin-top:20%">
		<div id="cspio-content" style="text-align: center;max-width: 100%;">
			
			<img id="cspio-logo" src="images/dark-logo.png" style="left: 50%;right: 50%" width="200px">
			    				
			<h1 id="cspio-headline">Site under maintenance</h1>				    				
...
<!-- Mirrored from seedprod.github.io/free-coming-soon-page/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Aug 2021 11:40:41 GMT -->
</html>
