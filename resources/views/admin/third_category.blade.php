      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="card-body">
            ...
            <div class="form-group">
              <label for="exampleInputEmail1">Third Category Slug</label>
              <input type="text" class="form-control" name="slug" placeholder="Sub category Slug" required>
            </div>
            <div class="form-group">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="card-body">
            ...
            <div class="form-group">
              <label for="exampleInputEmail1">Third Category Slug</label>
              <input type="text" class="form-control" name="slug" id="edit_slug" placeholder="Sub category slug" required>
            </div>
            <div class="form-group">
