      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6" style="display: flex;">
            <h1 class="m-0">Third Category</h1><button class="btn btn-success" style="margin-left: 10px" data-toggle="modal" data-target="#add_third_category"> Add</button>
          </div><!-- /.col -->
                    ...
                    <tbody>
                     ...
                     <tr>
                      ...
                      <td>{{$record->parent_category->name}}</td>
                     	...
                     	<td>
                     		<button class="btn btn-primary edit_category" name="{{$record->name}}" this_category_id="{{$record->id}}" parent_category_id="{{$record->parent_category_id}}"><i class="fas fa-edit"></i></button><a href="{{URL('admin/delete_sub_category/'.$record->id)}}" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                     	</td>
                     </tr>
                     @endforeach
                    </tbody>
...
<!-- Modal -->
        <form action="add_third_category" method="post" enctype="multipart/form-data">
          @csrf
<div class="modal fade" id="add_third_category" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-body">
          <div class="card-body">
                  <div class="form-group">
                    ...
                    <select type="text" class="form-control" name="parent_category_id" id='category_id' required>
